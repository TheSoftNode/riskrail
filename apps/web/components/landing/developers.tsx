...
const TABS = {
  sdk: {
    ...
    lines: [
      ...
      [""],
      ["await", " rivisk.portfolios.risk(addr);"],
      ["await", " rivisk.simulations.run(addr, {"],
      ["  shocks: [{ symbol: ", '"sBTC"', ", changeBps: -2000 }],"],
      ["});"],
      ["await", " rivisk.webhooks.create(url, [", '"risk.updated"', "]);"],
    ],
  },
  rest: {
    label: "REST",
  ...
  hook: {
    ...
    lines: [
      ["rivisk-signature: ", "t=1758…,v1=9f2c…"],
      ["rivisk-event-type: ", "risk.updated"],
      [""],
      ["{"],
      ['  "id": ', '"3f8a…"', ","],
      ['  "type": ', '"risk.updated"', ","],
